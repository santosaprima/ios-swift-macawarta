...
//  
//
//  Created by Prima Santosa on 09/01/21.
//
...
private extension URL {
  ...
  private static func makeEndpoint(_ endpoint: String) -> URL {
...
extension URL {
  ...
  // MARK: - Headlines
  public static func headlines(in country: String = "us", page: Int) -> URL {
    makeEndpoint(
  ...
  // MARK: - Explore
  public static func news(from category: String, in country: String = "us", page: Int) -> URL {
    makeEndpoint(
  ...
  // MARK: - Search
  public static func news(withKeyword keyword: String, page: Int, sortBy: String = "publishedAt") -> URL {
    makeEndpoint(
